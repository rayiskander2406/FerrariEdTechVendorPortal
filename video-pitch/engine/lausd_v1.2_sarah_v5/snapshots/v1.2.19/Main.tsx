...
// v1.2.19 Scene durations - Portal scene enlarged for detail visibility
// Total: 106.48 seconds
...
//
// Audio timeline (in full_voiceover_v1.2.18.mp3):
//   hook:        0.00s - 9.20s
//   hookStats:   10.00s - 22.10s
//   problem:     22.90s - 34.72s
//   solution:    35.52s - 51.49s
//   portal:      52.29s - 57.97s (NEW - 5.68s audio)
//   integration: 58.77s - 75.65s
//   benefits:    76.45s - 88.12s
//   leverage:    88.92s - 101.13s
//   close:       101.93s - 106.48s
...
const SCENES = {
  hook: {start: Math.round(0.00 * 30), duration: Math.round((9.20 - 0.00) * 30) + FADE_FRAMES},
  hookStats: {start: Math.round(9.20 * 30), duration: Math.round((22.10 - 9.20) * 30) + FADE_FRAMES},
  problem: {start: Math.round(22.10 * 30), duration: Math.round((34.72 - 22.10) * 30) + FADE_FRAMES},
  solution: {start: Math.round(34.72 * 30), duration: Math.round((51.49 - 34.72) * 30) + FADE_FRAMES},
  portal: {start: Math.round(51.49 * 30), duration: Math.round((57.97 - 51.49) * 30) + FADE_FRAMES},
  integration: {start: Math.round(57.97 * 30), duration: Math.round((75.65 - 57.97) * 30) + FADE_FRAMES},
  benefits: {start: Math.round(75.65 * 30), duration: Math.round((88.12 - 75.65) * 30) + FADE_FRAMES},
  leverage: {start: Math.round(88.12 * 30), duration: Math.round((101.13 - 88.12) * 30) + FADE_FRAMES},
  close: {start: Math.round(101.13 * 30), duration: Math.round((106.48 - 101.13) * 30)},
};
...
export const Main: React.FC = () => {
  return (
    <AbsoluteFill style={{backgroundColor: '#000'}}>
      {/* v1.2.18 voiceover - portal scene added after solution */}
      <Audio src={staticFile('voiceover/full_voiceover_v1.2.18.mp3')} />
