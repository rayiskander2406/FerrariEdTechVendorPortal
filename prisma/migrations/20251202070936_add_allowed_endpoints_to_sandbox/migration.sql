/*
  ...
  - You are about to drop the `DetokenizationApproval` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `SecurityAlert` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `TokenAccessLog` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `TokenMapping` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `VaultRateLimit` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `VaultRateLimitConfig` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropTable
DROP TABLE "DetokenizationApproval";

-- DropTable
DROP TABLE "SecurityAlert";

-- DropTable
DROP TABLE "TokenAccessLog";

-- DropTable
DROP TABLE "TokenMapping";

-- DropTable
DROP TABLE "VaultRateLimit";

-- DropTable
DROP TABLE "VaultRateLimitConfig";
